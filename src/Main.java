    ...
    public static void main(String[] args) {
        ...
        while (keepPlaying) {
            ...
            do {
                ...
                if (playerMove) {
                    System.out.println();
                    moveXrow = safeInput.SafeInput.getRangedInt(in, "Player X choose row: ", 1, 3) - 1;
                    moveXcol = safeInput.SafeInput.getRangedInt(in, "Player X choose col: ", 1, 3) - 1;
                    ...
                    moveOrow = safeInput.SafeInput.getRangedInt(in, "Player O choose row: ", 1, 3) - 1;
                    moveOcol = safeInput.SafeInput.getRangedInt(in, "Player O choose col: ", 1, 3) - 1;
            ...
            keepPlaying = safeInput.SafeInput.getYNConfirm(in, "\nWould you like to play again Y/N?: ");
        }
    }
